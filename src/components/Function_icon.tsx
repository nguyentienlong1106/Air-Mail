...
const Function_icon = () => {
  ...
  return (
    <div className="mt-[100px] ">
      <h2 className="font-ubuntu font-bold text-[40px] leading-[56px]">
        Если вы хотите
      </h2>
      <p className="text-[32px] leading-[44.8px] w-[995px] mt-[16px]">
      ...
      <div className="flex items-center gap-[35px] mt-[48px]">
        ...
        <div className="w-[737px]">
          <h3 className="font-medium text-[32px] leading-[44.8px]">
            Добиться доставляемости писем до 99.9%
          </h3>
          <p className="text-[24px] leading-[33.6px] text-description_dark mt-[16px] text-justify">
