...
const Step_email = () => {
  ...
  return (
    <div className="mt-[156px] mb-[300px] relative">
      ...
      <button className="bg-accent px-11 py-6 text-white rounded-[900px] text-[24px] leading-[31px] mt-[56px] absolute right-20 bottom-[-14rem] hover:scale-110 duration-100">
